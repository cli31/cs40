...
int main(int argc, char *argv[])
{
        ...
        fprintf(stderr, "queries populated after that\n");
        ...
        fprintf(stderr, "open the file to read\n");
        ...
        fprintf(stderr, "start timing & transforming\n");
        ...
        fprintf(stderr, "new image freed\n");

        // map(orig_image->pixels, printout, NULL);
        Pnm_ppmwrite(stdout, orig_image); // segfault here
